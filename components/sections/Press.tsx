...
// Interlúdio de Imprensa (design.md item 5b) — nova seção ENTRE a Prova Social
// (S5) e o Sobre (S6). Separa a prova emocional (transformações + vozes) da
// AUTORIDADE institucional (imprensa + prêmio). CONCEITO 'press clipping /
// interlúdio editorial': artefatos REAIS (o recorte da Honolulu Magazine + o
// selo azul real), não redesenho. Campo SAND PROFUNDO (o sand estreia como fundo
// de seção, tom guardado, sem cor nova na paleta) com textura de papel (SVG
// feTurbulence dessaturado, multiply) + vinheta morna. SEM vídeo, SEM fundo
// animado (decisão de diretor: editorial é papel + tipografia + diagramação, não
// movimento). Copy 100% do roteiro.md (intocável). Gabarito:
// mock-interludio-imprensa-v2.html, com o masthead SEM tracinho antes (Gabriel
// tirou; fere a regra 'sem tracinho de overline').
//
